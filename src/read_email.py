...
# Call the function and print the extracted links
eml_file_path = './input/talkwalker/talkwalker.eml'  # Replace with the actual eml file path
#extracted_links = extract_links_from_eml(eml_file_path)
df = extract_links_from_talkwalker(eml_file_path)
